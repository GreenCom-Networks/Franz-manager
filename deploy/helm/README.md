# franz-manager Helm Chart

* Installs the smooth and fancy alternative to kafka-manager: welcome [Franz-manager](https://franz-manager.io/)
...
```console
$ helm install --name my-new-kafka-manager .
```
...
## Configuration
TODO: configure with our parametrization
